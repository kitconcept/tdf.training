...
#
#  $ bin/test -s tdf.training -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src tdf.training.testing.TDF_TRAINING_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/tdf/training/tests/robot/test_example.robot
#
